...
export default function Header() {
  ...
  return (
    ...
    >
      {/* Greeting + Welcome */}
      <div>
        <p className="text-3xl font-bold ml-5">Employee FeedBack</p>
      </div>
      ...
      <div className={`relative w-100 ${darkMode ? "bg-gray-700" : "bg-white"} -mr-50`}>
        <input
          ...
          className={`w-full pl-10 pr-4 py-2 rounded-md border 
            ${darkMode ? "border-gray-600 bg-gray-700 text-white placeholder-gray-400 focus:ring-teal-400" : "border-gray-300 bg-white text-black placeholder-white focus:ring-teal-400"} 
