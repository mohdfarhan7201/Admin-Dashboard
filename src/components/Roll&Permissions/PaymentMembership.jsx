// src/components/PeymentsMembers.jsx
import React, { useState } from "react";
import { useTheme } from "../../context/ThemeContext";

const PeymentsMembership = [
...
const PeymentsMembers = () => {
  const { darkMode } = useTheme();

  const [permissions, setPermissions] = useState(
    PeymentsMembership.map(() => ({
      View: false,
      Create: false,
      Update: false,
      Delete: false,
    ...
    >
      ...
      <div className="overflow-x-auto">
        ...
        >
          ...
          <tbody>
            {PeymentsMembership.map((perm, rowIndex) => (
              <tr
                key={perm}
...
export default PeymentsMembers;
