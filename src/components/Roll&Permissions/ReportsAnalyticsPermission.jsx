// src/components/ReportsAnalyticsPermissions.jsx
...
const ReportsPermissions = [
  ...
  "Access Revenue/Financial Analytics",
  "Access Instructor Performance Analytics",
  "Generate Custom Reports",
];

const actions = ["View", "Create", "Update", "Delete", "Export"];

const ReportsAnalyticsPermissions = () => {
  const { darkMode } = useTheme();

  const [permissions, setPermissions] = useState(
    ReportsPermissions.map(() => ({
      View: false,
      Create: false,
      Update: false,
      Delete: false,
    ...
    >
      ...
      <div className="overflow-x-auto">
        ...
        >
          ...
          <tbody>
            {ReportsPermissions.map((perm, rowIndex) => (
              <tr
                key={perm}
...
export default ReportsAnalyticsPermissions;
