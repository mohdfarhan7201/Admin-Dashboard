// src/components/Permissions/ScheduleEventsPermission.jsx
...
const ScheduleEventsPermission = () => {
  const [permissions, setPermissions] = useState(
    SchedulePermissions.map(() => ({
      View: false,
      Create: false,
      Update: false,
      Delete: false,
    ...
    >
      ...
      <div className="overflow-x-auto">
        ...
        >
          ...
          <tbody>
            {SchedulePermissions.map((perm, rowIndex) => (
              <tr
                key={perm}
...
export default ScheduleEventsPermission;
