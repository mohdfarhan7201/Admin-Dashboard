// src/components/Permissions/SessionAppointmentPermissions.jsx
import React, { useState, useContext } from "react";
import { ThemeContext } from "../../context/ThemeContext";

const sessionPermissions = [
  "View All Sessions",
  "Create Modify Sessions",
  "Cancel Sessions",
...
const SessionAppointmentPermissions = () => {
  const [permissions, setPermissions] = useState(
    sessionPermissions.map(() => ({
      View: false,
      Create: false,
      Update: false,
      Delete: false,
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center mb-3">
        ...
        >
          Session & Appointment Permissions
        </h3>
      ...
      <div className="overflow-x-auto">
        ...
        >
          ...
          <tbody>
            {sessionPermissions.map((perm, rowIndex) => (
              <tr
                key={perm}
...
export default SessionAppointmentPermissions;
